...
Chapter 1 — **Computing with DNA** — is the new internally reviewed prototype: ten original editable figures, semantic Unicode TXT, an exact Python companion, exercises with solutions, glossary, bibliography and index. The 32-chapter architecture remains; only Chapter 1 is drafted.

Read the [deep PDF](output/pdf/deep-dna-computing.pdf), [chapter source](tex/deep/ch01.tex), [production report](DEEP_CHAPTER_1_REPORT.md), [edition strategy](CANONICAL_EDITION_STRATEGY.md), [book plan](BOOK_PLAN.md) and [chapter standard](CHAPTER_STANDARD.md).
