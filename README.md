...
The undergraduate experiment is preserved at astra-undergraduate-rewrite commit 0779ed552b26d678e2443c0d94177faa04dc293c. Its [source](tex/undergraduate/ch01.tex), [historical report](CHAPTER_1_REPORT.md) and [historical PDF](output/pdf/undergraduate-dna-computing.pdf) remain available, but are not the active intellectual target. Earlier astra-rewrite and pre-reboot snapshots are unchanged. No main merge, deletion, license or authorship change is included.
