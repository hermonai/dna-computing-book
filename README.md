...
The plan contains 36 small teaching units. It is a proposed learning route, not a completed book or a validated semester schedule. Book I builds the eventual prerequisite curriculum for Evolutor.

## Preservation and build boundary

The two-chapter edition is preserved on [astra-rewrite at a1fb9a6](https://github.com/hermonai/dna-computing-book/tree/a1fb9a6154976f903b39d0f8a26834a8336f2264). The earlier public edition remains on main. No force-push, deletion, default-branch, license or authorship change is made.
