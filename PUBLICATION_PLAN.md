...
Historical reproduction is explicit: make historical-pdf uses tex/undergraduate-dna-computing.tex and builds only under build/. The committed output/pdf/undergraduate-dna-computing.pdf remains byte-identical. The historical gate accepts the preserved edition metadata for regression tests but not as the active deep manuscript.
