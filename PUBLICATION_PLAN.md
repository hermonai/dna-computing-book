...
Title: DNA Computing. Subtitle: From Molecules to Algorithms. Edition label: **2-development**, a new major intellectual edition, not a final release. No author attribution or license is changed. The active shell is a prospectus and typesetting check, not a manuscript with placeholder chapters. Historic material is never included automatically.
