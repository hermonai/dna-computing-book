...
def master(dna):
    if dna:
        ...
        for x,lab in [(55,"TWO FRAGMENTS"),(350,"NICKED DUPLEX"),(645,"SEALED BACKBONE")]:
            body+=txt(x+105,118,lab,19,"bold","middle")
        body+=strand(55,165,200,paired=False,nick=True)
        body+=txt(155,230,"+ complementary splint",17,anchor="middle")
        ...
        for y,label,blocked in [(151,"A  Promoter occupied: initiation inhibited",True),(307,"B  Promoter accessible: initiation may occur",False)]:
            ...
            if blocked:
                ...
                body+=protein(610,y-5,"RNAP")
                body+=txt(684,y-1,"not recruited",18)
            else:
