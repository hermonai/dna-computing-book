...
**Combinatorial search and complexity** now has an expanded [manuscript](drafts/ch03/manuscript.md) of approximately 3483 whitespace-delimited words, eight original editable SVG figures with semantic TXT companions, and twelve exercises with worked reasoning. The 12-figure storyboard has four mechanisms still awaiting artwork. All eight newly produced figures across the two books were rendered and visually inspected; a chart annotation was moved off its data line and reverse-gradient arrows were made explicit. This is figure review, not PDF page review.

The new material separates encoded input length from numeric value and physical copies; derives deterministic complement closure; compares factorial orders, reachable states and neighbor scans; and proves the one-pass edge-deletion invariant. The executable trace records each trial answer and retained graph, checked against independent enumeration on every one of the 4,096 four-vertex directed graphs.
...
The full suite passes **205 tests**, including **27 working-draft tests**, the publication build in an isolated temporary copy, and source/PDF preservation checks. The accepted Chapters 1–2 source hashes and original published PDF bytes remain unchanged. No acceptance gate was weakened.
