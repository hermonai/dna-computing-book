# Chapter 14: Sticker systems and molecular memory
...
```sh
python3 drafts/ch14/build.py --assets-only
python3 -m pytest tests/test_ch14_reference.py
python3 drafts/ch14/build.py --render
python3 drafts/ch14/build.py --check
```

Output: output/pdf/dna-computing-ch14-review.pdf.
