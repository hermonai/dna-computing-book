...
\section*{Pedagogical reference}
Sebastian Raschka's author-maintained companion to
\emph{Build a Large Language Model (From Scratch)} was inspected for its
chapter map and read--code--exercise progression:
\url{https://www.sebastianraschka.com/llms-from-scratch/}.
The full commercial book was not inspected. Our prose, examples, code, and
vector plates are original; no source artwork or distinctive passages are copied.
