...
NAME = ("dna-computing" if DNA else "evolutor") + "-ch17-review"
BUILD = ROOT / "build/ch17"


def derived():
    spec = importlib.util.spec_from_file_location(
        "chapter17_reference", HERE / "reference.py"
    )
...
def main():
    ...
    if a.check or a.assets_only:
        print(
            "Chapter 17 computed artifacts verified"
            if a.check
            else "Chapter 17 computed artifacts generated"
        )
        return
