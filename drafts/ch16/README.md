...
```sh
python3 drafts/ch16/build.py --assets-only
python3 -m pytest tests/test_ch16_reference.py
python3 drafts/ch16/build.py --render
python3 drafts/ch16/build.py --check
```

Output: output/pdf/dna-computing-ch16-review.pdf.
