# Chapter 10: Separation, readout, and measurement
...
Requires Python 3.10+, NumPy, pytest, Pillow, XeLaTeX/latexmk,
Poppler and the fonts specified in review.tex.
PDF: output/pdf/dna-computing-ch10-review.pdf (generated, gitignored).
